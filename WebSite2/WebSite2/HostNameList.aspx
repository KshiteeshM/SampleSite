...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container w-100" style="background-color: white;">
            ...
            <hr />
            <asp:Label runat="server" Text="Select the hostname whose LM_Critical information you want to retrieve and click on center" CssClass="h4"></asp:Label>
            <br />
            <asp:RadioButtonList ID="RadioButtonList1" runat="server" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" CssClass="checkbox checkbox-primary text-muted">
            </asp:RadioButtonList>
            <br />
