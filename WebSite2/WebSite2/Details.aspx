...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container w-100" style="background-color: white;">
            ...
            <hr />
            &nbsp;
            <asp:Label ID="Label1" runat="server" Text="List" CssClass="h4"></asp:Label>
            <br />
            <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            </asp:GridView>
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Button" CssClass="basicButton" />
            <br />
            <br />
            <br />
        </div>
